...
$url_page = "focus_list.php?userid=$user_id&page=";
...
$sql = "select count(1) as retcount from funs_list f,users u where f.numeral_user_id='$num_id' and
